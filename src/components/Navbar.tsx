  ...
  return (
    <header
      className={cn(
        ...
        isScrolled ? 'bg-github-darker/90 border-b border-github-border shadow-sm' : 'bg-transparent'
      )}
    >
      ...
      <div
        className={cn(
          'md:hidden fixed inset-x-0 top-16 bg-github-darker/95 backdrop-blur-lg transition-all duration-300 ease-in-out shadow-md overflow-hidden border-b border-github-border',
